...
# and transformers/src/transformers/models/internlm3/configuration_internlm3.py
#
...
from paddleformers.transformers.modeling_rope_utils import rope_config_validation
...
class InternLM3Config(PretrainedConfig):
    ...
    an InternLM3 model according to the specified arguments, defining the model architecture. Instantiating a configuration with the defaults will yield a configuration to that of the InternLM3-8B.
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 128512):
            Vocabulary size in the InternLM3 model. Defines the number of different tokens that can be represented by the
    ...
    Example:
        >>> from paddleformers.transformers.intern_lm3 import InternLM3Config, InternLM3Model
