...
import_structure = {
    ...
    "florence2.processing": ["Florence2Processor"],
    "florence2.modeling": ["DaViT", "Florence2Model", "Florence2VisionModel", "Florence2VisionModelWithProjection", "Florence2ForConditionalGeneration"],
