...
import_structure = {
    ...
    "fastvlm.configuration": ["FastVLMConfig"],
    "fastvlm.image_processor": ["FastVLMImageProcessor"],
    "fastvlm.processor": ["FastVLMProcessor"],
    "fastvlm.modeling": ["FastVLMModel", "FastVLMForCausalLM", "FastVLMForConditionalGeneration"],
