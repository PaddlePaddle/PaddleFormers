...
import_structure = {
    ...
    "siglip_vision_model.modeling": [
        "SiglipMultiheadAttentionPoolingHead",
        "SiglipVisionPretrainedModel",
        "SiglipVisionModel",
    ],
    "llava_next.configuration": ["LlavaNextConfig"],
    "llava_next.modeling": [
    ...
    "llava_next.image_processor": ["LlavaNextImageProcessor"],
    "llava_next.processor": ["LlavaNextProcessor"],
