...
from .modeling import Qwen2Config, Qwen2DecoderLayer, Qwen2Model, Qwen2PretrainedModel
...
class Qwen2LMHeadPipe(GeneralLMHead):
    def __init__(self, config):
        super(Qwen2LMHeadPipe, self).__init__(config)
...
class Qwen2ForCausalLMPipe(PipelinePretrainedModel, PipelineLayer):
    ...
    def __init__(self, config: Qwen2Config):
        ...
        if config.tie_word_embeddings:
            ...
            self.add_sequential_layer(LayerDesc(Qwen2EmbeddingPipe, config=config), "model")
        ...
        self.add_sequential_layer(LayerDesc(Qwen2RMSNormPipe, config=config), "model")
