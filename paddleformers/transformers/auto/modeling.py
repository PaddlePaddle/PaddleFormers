...
class _BaseAutoModelClass:
    ...
    def _get_model_class_from_config(
        ...
        resolved_model_type = resolve_minicpm4_model_type(config, model_type_override)
        ...
        model_name = "MiniCPM4Model" if resolved_model_type == "minicpm4" else None
