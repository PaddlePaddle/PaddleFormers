...
class Qwen2_5_VLProcessor(ProcessorMixin):
        ...
        **kwargs: Unpack[Qwen2_5_VLProcessorKwargs],
        ...
        if videos is not None:
            ...
            if isinstance(fps, (int, float)):
                ...
                second_per_grid_ts = [
                    self.video_processor.temporal_patch_size / tmp
                    for tmp in fps
                ]
            else:
                raise ValueError(
    ...
    def _get_num_multimodal_tokens(
        ...
        if image_sizes is not None:
            images_kwargs = Qwen2_5_VLProcessorKwargs._defaults.get(
                "images_kwargs", {}
            )
        ...
        if video_sizes is not None:
            videos_kwargs = Qwen2_5_VLProcessorKwargs._defaults.get(
                "videos_kwargs", {}
            )
