    ...
    def _init_weights(self, module):
        ...
        if isinstance(module, Qwen3VLMoeTextExperts):
            ...
            inv_freq = 1.0 / (
                module.theta
                ** (
                    paddle.arange(0, module.dim, 2, dtype=paddle.float)
                    / module.dim
                )
            )
...
class Qwen3VLMoeVisionModel(Qwen3VLMoePretrainedModel):
    ...
    def __init__(self, config, *inputs, **kwargs) -> None:
        ...
        self.blocks = nn.LayerList(
            [Qwen3VLMoeVisionBlock(config) for _ in range(config.depth)]
        )
...
class Qwen3VLMoeModelOutputWithPast(ModelOutput):
    ...
    last_hidden_state: paddle.Tensor | None = None
...
class Qwen3VLMoeTextRotaryEmbedding(nn.Layer):
    ...
    def __init__(self, config: Qwen3VLMoeTextConfig):
        ...
        self.mrope_section = config.rope_parameters.get(
...
class Qwen3VLMoeTextAttention(nn.Layer):
    ...
    def __init__(
        self, config: Qwen3VLMoeTextConfig, layer_idx: int | None = None
    ):
        super().__init__()
        self.config = config
...
class Qwen3VLMoeTextTopKRouter(nn.Module):
    def __init__(self, config):
        ...
        self.weight = nn.Parameter(
            paddle.zeros(self.hidden_dim, self.num_experts)
        )
    ...
    def forward(self, hidden_states):
        ...
        router_logits = nn.functional.softmax(
            router_logits, dtype=paddle.float, dim=-1
        )
        router_top_value, router_indices = paddle.topk(
    ...
    def forward(
        ...
        **kwargs,
        ...
        for idx, (decoder_layer) in enumerate(self.layers):
            ...
            if deepstack_visual_embeds is not None and idx < len(
...
class Qwen3VLMoeModelDeprecated(Qwen3VLMoePretrainedModel):
    ...
    def __init__(self, config):
        ...
        self.language_model = Qwen3VLMoeTextModel._from_config(
            config.text_config
        )
    ...
    def get_rope_index(
        ...
        image_grid_thw: paddle.Tensor | None = None,
        video_grid_thw: paddle.Tensor | None = None,
        attention_mask: paddle.Tensor | None = None,
        ...
        if input_ids is not None and (
            ...
            mrope_position_deltas = paddle.tensor(
    ...
    def get_placeholder_mask(
        ...
        image_features: paddle.Tensor | None = None,
        video_features: paddle.Tensor | None = None,
    ):
        """
    ...
    def forward(
        ...
        pixel_values_videos: paddle.Tensor | None = None,
        image_grid_thw: paddle.Tensor | None = None,
        video_grid_thw: paddle.Tensor | None = None,
        rope_deltas: paddle.Tensor | None = None,
        cache_position: paddle.Tensor | None = None,
...
def load_balancing_loss_func(
    ...
    if attention_mask is None:
        ...
        ) / paddle.sum(expert_attention_mask, dim=0)
        ...
        ) / paddle.sum(router_per_expert_attention_mask, dim=0)

    overall_loss = paddle.sum(
...
class Qwen3VLMoeCausalLMOutputWithPast(ModelOutput):
    ...
    attentions: tuple[paddle.Tensor] | None = None
    rope_deltas: paddle.Tensor | None = None
    aux_loss: paddle.Tensor | None = None
...
class Qwen3VLMoeForConditionalGenerationDeprecated(Qwen3VLMoePretrainedModel):
    ...
    def _expand_inputs_for_generation(
        ...
        input_ids: paddle.int64 | None = None,
        **model_kwargs,
