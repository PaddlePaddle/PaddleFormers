...
from .moe_ep_gate import PretrainedMoEGate, QwenMoeGate
...
class QwenMoeBlock(MoELayer):
    def __init__(self, config, expert_class, use_shared_expert=True):
        gate = QwenMoeGate(
            config,
            config.num_experts,
            config.hidden_size,
        ...
        if use_shared_expert:
            self.shared_expert = expert_class(config, is_shared=True)
