...
class MOEAllGatherLayerV2(MOEAlltoAllLayer):
    ...
    def __init__(
        ...
        self.multimodal_experts = (
            isinstance(moe_num_experts, (tuple, list))
            and len(moe_num_experts) > 1
        )
        self.send_rank = None
    ...
    def fused_gate_logits_process_fused(
        ...
        lm_weight_and_expert_id = paddle.cat(
        ...
        mm_weight_and_expert_id = paddle.cat(
    ...
    def forward_experts(self, *dispatched_input):
        ...
        for iexpert, chunk in enumerate(dispatched_input):
            if chunk is None:
                ...
                if not isinstance(
                    true_experts[iexpert].down_proj, QuantizationLoRALinear
                ):
                    input_shape = [
                        1,
