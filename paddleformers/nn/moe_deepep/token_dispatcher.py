...
from ...transformers.fused_a2a import fused_combine, fused_dispatch
from ...transformers.moe_utils import permute, unpermute
...
class MoEFlexTokenDispatcher(MoETokenDispatcher):
    ...
    def token_permutation(
        ...
        def print_func(x):
            print("line token_permutation", x)

        global_input_tokens.register_hook(print_func)
    ...
    def token_unpermutation(
        ...
        def print_func(x):
            print("line token_unpermutation ", x)

        hidden_states.register_hook(print_func)
