...
def get_pp_schedule(model, model_type, n_microbatches, loss_fn, mode, pp_degree, group, need_shared_params=False):
    ...
    elif model_type == "ernie_pp":
        return get_llama_pp_schedule(model, n_microbatches, loss_fn, mode, pp_degree, group, need_shared_params=True)
