...
register_multimodel_keys(
    MultiModelKeys(
        ...
        aligner=[
            ...
            "model.vision_model.$LAYER_ID.linear_fc1",
            "model.vision_model.$LAYER_ID.linear_fc2",
            "model.vision_model.$LAYER_ID.norm",
            "model.vision_model.$LAYER_ID.deepstack_merger",
        ],
        llm=["model.language_model", "lm_head"],
