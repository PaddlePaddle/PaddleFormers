...
from paddleformers.datasets2.collate import collate_fn
...
def run_sft(
    ...
    if "GptOss" in str(model_config.architectures) and data_args.packing is False and not is_sm90:
        model_config.attn_impl = "eager"
