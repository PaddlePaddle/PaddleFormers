...
try:
    setuptools.setup(
        ...
        extras_require={
            "paddlefleet": [
                f"paddlefleet @ https://paddle-github-action.cdn.bcebos.com/PaddleFleet/release/0.1.0/latest/cu129/paddlefleet-0.0.0-cp{ver_str}-cp{ver_str}-linux_x86_64.whl; platform_system == 'Linux' and platform_machine == 'x86_64'"
            ],
        },
        python_requires=">=3.8",
        classifiers=[
