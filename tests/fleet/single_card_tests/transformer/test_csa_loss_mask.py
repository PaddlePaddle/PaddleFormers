...
class TestCSAForwardLossMaskComputation(unittest.TestCase):
    ...
    @patch("paddleformers.fleet.transformer.csa_attention.ContextParallelGatherOp")
    @patch(
        "paddleformers.fleet.transformer.csa_attention.get_context_parallel_world_size",
        return_value=2,
    )
    @patch("paddleformers.fleet.fusions.csa_sparse_attn.csa_sparse_attn")
