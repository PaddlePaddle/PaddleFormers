...
class TestPaddleFleetInit(unittest.TestCase):
    """Tests for paddleformers.fleet top-level __init__.py."""

    def test_import_paddleformers_fleet(self):
        """Test that paddleformers.fleet can be imported."""
        import paddleformers.fleet

        self.assertIsNotNone(paddleformers.fleet)
