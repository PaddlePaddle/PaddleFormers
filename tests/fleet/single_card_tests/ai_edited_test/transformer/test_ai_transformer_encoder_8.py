...
class TestTransformerEncoderSetStateDict(unittest.TestCase):
    ...
    def test_set_state_dict_remaps_keys(self):
        ...
        with patch.object(TransformerEncoder, "__init__", lambda self, *a, **kw: None):
            ...
            with patch.object(type(encoder).__mro__[1], "set_state_dict", return_value=True) as mock_super:
    ...
    def test_set_state_dict_skips_unknown_keys(self):
        ...
        with patch.object(TransformerEncoder, "__init__", lambda self, *a, **kw: None):
            ...
            with patch.object(type(encoder).__mro__[1], "set_state_dict", return_value=True):
...
class TestTransformerEncoderFP8QuantWeight(unittest.TestCase):
    ...
    def test_fp8_quant_weight_single_stage(self):
        ...
        with patch.object(TransformerEncoder, "__init__", lambda self, *a, **kw: None):
            ...
            mock_layer.fp8_quant_weight.assert_called_once_with(batch_mode=True, quant_transpose=False)
