...
# This is the triton_compat in the ops package, different from the src/paddleformers.fleet one
...
@unittest.skipUnless(_TRITON_COMPAT_AVAILABLE, "paddlefleet_ops triton_compat not available")
