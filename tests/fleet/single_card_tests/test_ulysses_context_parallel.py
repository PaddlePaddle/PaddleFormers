...
class TestUlyssesAlltoAll(unittest.TestCase):
    ...
    @patch(
        "paddleformers.fleet.context_parallel_utils._ulysses_single_all_to_all"
    )
    @patch(
        "paddleformers.fleet.context_parallel_utils._ulysses_fused_supported"
    )
...
class TestFlashmaskAttentionCpModeRouting(unittest.TestCase):
    ...
    @patch(
        "paddleformers.fleet.context_parallel_utils.FlashMaskContextParallel.apply"
    )
    ...
    @patch(
        "paddleformers.fleet.context_parallel_utils.flashmask_attention_ulysses"
    )
...
class TestContextParallelOpsBackward(unittest.TestCase):
    ...
    @patch(
        "paddleformers.fleet.context_parallel_utils.reduce_scatter_contiguous"
    )
    @patch(
