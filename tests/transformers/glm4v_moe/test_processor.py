...
class Glm4vMoeProcessorTest(ProcessorTesterMixin, unittest.TestCase):
    ...
    def test_save_load_pretrained_default(self):
        ...
        self.assertEqual(
            processor.tokenizer.__class__.__name__, "TokenizersBackend"
        )
        self.assertEqual(
            processor.image_processor.__class__.__name__, "Glm4vImageProcessor"
        )
        self.assertEqual(
            processor.video_processor.__class__.__name__, "Glm4vVideoProcessor"
        )
