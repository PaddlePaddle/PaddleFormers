...
class RoPEUtilsTest(unittest.TestCase):
    ...
    def test_compute_dynamic_ntk_parameters(self):
        ...
        expected_inv_freq_no_scale = 1.0 / (
            base_no_scale ** (paddle.arange(0, dim, 2, dtype=paddle.float32) / dim)
        )
    ...
    def test_rope_config_validation_linear_scaling_invalid_factor(self):
        config = FakePretrainedConfig(
            rope_parameters={"rope_type": "linear", "rope_theta": 10000.0, "factor": 0.5}
        )
    ...
    def test_rope_config_validation_yarn_invalid_params(self):
        ...
        self.assertTrue(any("please correct the 'max_position_embeddings' fields in the model config" in msg for msg in messages))
    ...
    def test_rope_config_validation_llama3_invalid_params(self):
        ...
        self.assertTrue(any("original_max_position_embeddings field must be less than max_position_embeddings" in msg for msg in messages))
