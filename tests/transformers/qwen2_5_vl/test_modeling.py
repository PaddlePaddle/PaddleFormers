...
class Qwen2_5_VLIntegrationTest(unittest.TestCase):
    def setUp(self):
        config = Qwen2_5_VLConfig.from_pretrained("PaddleFormers/tiny-random-qwen2.5vl")
        config.text_config.dtype = "bfloat16"
        config.vision_config.dtype = "bfloat16"
        self.model = Qwen2_5_VLForConditionalGeneration.from_config(config)
    ...
    def test_model_tiny_logits(self):
        ...
        self.assertTrue(inputs is not None)
