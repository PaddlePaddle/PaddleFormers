...
class Qwen2_5_VLModelTester:
    ...
    def prepare_config_and_inputs_for_common(self):
        ...
        # inputs_dict = {
        #     "input_ids": inputs_dict["input_ids"].astype("int"),
        #     "attention_mask": inputs_dict["attention_mask"].astype("int64"),
        #     "pixel_values": inputs_dict["pixel_values"].astype("float32"),
        #     "image_grid_thw": inputs_dict["image_grid_thw"].astype("int32"),
        # }
        return config, inputs
