...
class Qwen2_5_VLModelTest(
    ...
    all_generative_model_classes = {
        Qwen2_5_VLForConditionalGeneration: {Qwen2_5_VLModel, "qwen2_5_vl"}
    }
    max_new_tokens = 3
...
class Qwen2_5_VLCompatibilityTest(unittest.TestCase):
    ...
    def test_Qwen2_5_VL_converter(self):
        ...
        torch_model = Qwen2_5_VLModel.from_pretrained(
    ...
    @require_package("transformers", "torch")
    def test_Qwen2_5_VL_classes_from_local_dir(
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            if class_name == "Qwen2_5_VLModel":
                ...
                paddle_fused_logit = paddle_model_fused(**paddle_inputs)[
                    "logits"
                ]
