...
class Qwen3VLIntegrationTest(unittest.TestCase):
    ...
    def test_model_tiny_logits(self):
        ...
        EXPECTED_SLICE = paddle.to_tensor(
            [
                -0.04830123,  0.01787715,  0.00991759, -0.02347296, -0.04079819,
        -0.02150381,  0.00212364, -0.00509107, -0.00691510, -0.08602027,
        -0.02233317,  0.04169520,  0.00664806, -0.01436852,  0.01152703,
        -0.06698436, -0.00013593, -0.00659225, -0.01239884,  0.08785237,
         0.04450346, -0.00619736, -0.00455347, -0.02874838, -0.00361449,
         0.00863984,  0.02070246, -0.06878687, -0.06700088,  0.04187571,
            ]
        )
    ...
    def test_model_tiny_logits_batch(self):
        ...
        EXPECTED_SLICE = paddle.to_tensor(
            [
                -0.04830123,  0.01787717,  0.00991760, -0.02347296, -0.04079819,
        -0.02150383,  0.00212366, -0.00509107, -0.00691510, -0.08602025,
        -0.02233317,  0.04169523,  0.00664805, -0.01436852,  0.01152704,
        -0.06698435, -0.00013594, -0.00659226, -0.01239885,  0.08785236,
         0.04450347, -0.00619736, -0.00455347, -0.02874839, -0.00361450,
         0.00863984,  0.02070246, -0.06878690, -0.06700090,  0.04187573,
            ]
        )
    ...
    def test_model_tiny_logits_batch_wo_image(self):
        ...
        EXPECTED_SLICE_1 = paddle.to_tensor(
            [
                0.01120307,  0.02055009, -0.01563728, -0.04712614,  0.01662372,
        -0.02085639,  0.01338269,  0.02397793,  0.04716877,  0.08659735,
        -0.02082073, -0.02569836, -0.05355629, -0.04573849,  0.03354743,
         0.02924869, -0.02651470, -0.03001252,  0.00152938,  0.00770529,
        -0.09544949,  0.00128273,  0.04475499,  0.03629422,  0.05514427,
        -0.00806767, -0.04386345, -0.05077611,  0.01993031, -0.02982330,
            ]
        )
        EXPECTED_SLICE_2 = paddle.to_tensor(
            [
                0.10130517,  0.00206762, -0.00893505,  0.05437529,  0.01119215,
        -0.04609555,  0.05206053, -0.02397311,  0.03425191, -0.00590183,
         0.00371889, -0.06085320, -0.02652358,  0.06330102, -0.03315021,
         0.01690439, -0.01701316, -0.01324541, -0.01316613, -0.06717704,
         0.00280074, -0.03841571, -0.00536565, -0.06016248, -0.01849442,
        -0.01973890,  0.05998241, -0.02303025, -0.04837557,  0.06587651,
            ]
        )
    ...
    def test_model_tiny_logits_with_video(self):
        ...
        EXPECTED_SLICE = paddle.to_tensor(
            [
                -0.03159378, -0.02983775, -0.03178139, -0.05379442,  0.04444192,
         0.00526612, -0.03020275,  0.03783429,  0.04220121,  0.06543212,
         0.00112945, -0.00324509, -0.03932452, -0.02699309,  0.00205359,
         0.02623662,  0.03199109,  0.02355516,  0.04486428, -0.00968292,
        -0.02594341,  0.01487124,  0.01107915, -0.00751028,  0.04806545,
        -0.04173433,  0.00094549, -0.04580990,  0.02262657,  0.03348221,
            ]
        )
