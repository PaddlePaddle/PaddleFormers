...
from paddleformers.transformers import (
    ...
    Qwen3VLModelDeprecated as Qwen3VLModel,
    process_vision_info,
)
...
class Qwen3VLModelTest(
    ...
    all_generative_model_classes = {
        Qwen3VLForConditionalGeneration: {Qwen3VLModel, "qwen3_vl"}
    }
    max_new_tokens = 3
    ...
    def setUp(self):
        ...
        self.config_tester = ConfigTester(
            self, config_class=Qwen3VLConfig, has_text_modality=False
        )
...
class Qwen3VLCompatibilityTest(unittest.TestCase):
    ...
    @require_package("transformers", "torch")
    def test_Qwen3VL_classes_from_local_dir(
