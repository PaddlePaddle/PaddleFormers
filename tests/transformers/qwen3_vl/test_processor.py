...
class Qwen3VLProcessorTest(ProcessorTesterMixin, unittest.TestCase):
    ...
    def test_apply_chat_template_video_frame_sampling(self):
        ...
        self.assertEqual(
            len(out_dict_with_video[self.videos_input_name]), 129600
        )
        ...
        self.assertTrue(self.videos_input_name in out_dict_with_video)
        self.assertEqual(
            len(out_dict_with_video[self.videos_input_name]), 518400
        )
        ...
        self.assertTrue(self.videos_input_name in out_dict_with_video)
        self.assertEqual(
            len(out_dict_with_video[self.videos_input_name]), 780912
        )
        ...
        self.assertTrue(self.videos_input_name in out_dict_with_video)
        self.assertEqual(
            len(out_dict_with_video[self.videos_input_name]), 71280
        )
