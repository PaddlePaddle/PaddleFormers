...
class Qwen2MoeModelTest(
    ...
    all_generative_model_classes = {
        Qwen2MoeForCausalLM: (Qwen2MoeModel, "qwen2_moe")
    }
    ...
    def setUp(self):
        ...
        self.config_tester = ConfigTester(
            self, config_class=Qwen2MoeConfig, vocab_size=256, hidden_size=24
        )
...
class Qwen2MoeCompatibilityTest(unittest.TestCase):
    ...
    def test_Qwen2Moe_converter(self):
        ...
        torch_model = Qwen2MoeForCausalLM.from_pretrained(
