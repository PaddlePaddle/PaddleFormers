...
class Qwen3VLMoeIntegrationTest(unittest.TestCase):
    ...
    def test_model_tiny_logits(self):
        ...
        EXPECTED_SLICE = paddle.to_tensor(
            [
                1.77021563, -0.08357339,  1.72820771, -1.67181456, -1.78766191,
        -0.63696754, -0.54018718, -1.54490316, -0.41880208,  0.98724669,
         0.50626910, -0.14008330,  0.11813132,  1.62357569, -1.72143626,
         0.80836982, -2.29651117, -2.55041718, -0.03479451,  0.36371940,
         1.26565969, -1.48960710,  0.04773904, -1.29565358, -1.10251284,
         1.64874637, -0.54735196,  1.14902794,  0.63577825,  1.72434473,
            ]
        )
    ...
    def test_model_tiny_logits_batch(self):
        ...
        EXPECTED_SLICE = paddle.to_tensor(
            [
                1.77021539, -0.08357349,  1.72820759, -1.67181444, -1.78766179,
        -0.63696742, -0.54018706, -1.54490316, -0.41880196,  0.98724639,
         0.50626904, -0.14008322,  0.11813107,  1.62357569, -1.72143602,
         0.80836987, -2.29651093, -2.55041766, -0.03479471,  0.36371952,
         1.26566005, -1.48960710,  0.04773920, -1.29565334, -1.10251260,
         1.64874601, -0.54735172,  1.14902771,  0.63577825,  1.72434509,
            ]
        )
    ...
    def test_model_tiny_logits_batch_wo_image(self):
        ...
        EXPECTED_SLICE_1 = paddle.to_tensor(
            [
                -0.00306564, -1.90969706, -0.30317274, -1.27139270,  1.04501450,
         1.06342554, -1.62821472,  0.83540285,  0.21029894,  0.45072240,
        -0.20456408,  0.82867992, -0.18769921,  1.74863970, -0.25607949,
         1.52637076, -1.85399902,  1.27215552, -2.24474525, -0.60716891,
        -0.38690233, -0.05219988, -1.55089211,  1.66028666, -1.07749856,
         2.12503290, -1.92487442, -1.22063696,  0.54736096, -0.87428522,
            ]
        )
        EXPECTED_SLICE_2 = paddle.to_tensor(
            [
                0.95401186, 0.41192770, 0.05070265, -0.44604224, 0.64093876, -0.28572276,
        2.66299891, 0.66410595, -0.60175616, 2.36748886, -0.12926564, -1.02353859,
        -0.26600769, 2.30087090, -1.35262311, -0.54072106, 0.61221671, 0.34256074,
        1.36241472, 1.35481548, -0.79429966, -0.08122503, -1.04479063, -0.45793974,
        0.47145078, -1.85688376, -0.18537493, 1.12954021, 0.46777514, 1.50198495,
            ]
        )
    ...
    def test_model_tiny_logits_with_video(self):
        ...
        EXPECTED_SLICE = paddle.to_tensor(
            [
                -0.53355724,  0.10110144, -0.15221886, -1.50670421,  0.04828912,
         0.84951532, -0.94002789, -0.09058289, -1.34453082, -0.23910277,
         1.72044337,  0.35392100, -0.83529609,  1.63142085, -1.43895960,
         1.93913543, -0.82009524,  1.42548537,  0.13718361, -1.87809551,
         1.01746726,  2.14836812, -0.94631994,  1.36813104,  2.92559791,
         0.75968164, -2.06777072, -3.07273746, -0.07574638, -0.63305897,
            ]
        )
