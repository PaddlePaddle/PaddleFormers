...
class ModelConfig:
    model_name_or_path: str = field(
        default=None,
        metadata={
            "help": "Built-in pretrained model name or the path to local model."
        },
    )
    ...
    pissa: bool = field(
        default=False,
        metadata={
            "help": "Whether to use Pissa: https://arxiv.org/pdf/2404.02948.pdf"
        },
    )
    lora_use_mixer: bool = field(
        default=False,
        metadata={
            "help": "Whether to use MosLoRA: https://arxiv.org/pdf/2406.11909"
        },
    )
    use_mora: bool = field(
        default=False,
        metadata={
            "help": "Whether to use MoRA: https://arxiv.org/pdf/2405.12130.pdf"
        },
    )
    lorapro: bool = field(
        default=False,
        metadata={
            "help": "Whether to use LoRA-Pro: https://arxiv.org/pdf/2407.18242"
        },
    )
    lorapro_x_mode: str = field(
        default="zero",
        metadata={
            "help": "X mode for AdamWLoRAPro optimizer (zero, sylvester, symmetry)."
        },
    )
    ...
    vera: bool = field(
        default=False, metadata={"help": "Whether to use vera technique"}
    )
    vera_rank: int = field(
        default=8, metadata={"help": "Vera attention dimension"}
    )

    # lokr related parameter
    lokr: bool = field(
        default=False, metadata={"help": "Whether to use LoKr technique"}
    )
    lokr_path: str = field(
        default=None,
        metadata={
            "help": "Initialize lokr state dict and apply customized lokr config"
        },
    )
    lokr_dim: int = field(
        default=8,
        metadata={
            "help": "Lora dimension in LoKr dimension for adapter matrix"
        },
    )

    # prefix tuning related parameters
    prefix_tuning: bool = field(
        default=False, metadata={"help": "Whether to use Prefix technique"}
    )
    prefix_path: str = field(
        default=None, metadata={"help": "Initialize prefix state dict."}
    )
    num_prefix_tokens: int = field(
        default=128, metadata={"help": "Number of prefix tokens"}
    )

    # reft related parameter
    reft: bool = field(
        default=False, metadata={"help": "Whether using reft method"}
    )

    save_to_aistudio: bool = field(
        default=False, metadata={"help": "Whether to save model to aistudio"}
    )
    aistudio_repo_id: str = field(
        default=None, metadata={"help": "The id of aistudio repo"}
    )
    aistudio_repo_private: bool = field(
        default=True, metadata={"help": "Whether to create a private repo"}
    )
    aistudio_repo_license: str = field(
        default="Apache License 2.0",
        metadata={"help": "The license of aistudio repo"},
    )
    aistudio_token: str = field(
        default=None, metadata={"help": "The token of aistudio"}
    )
    neftune: bool = field(
    ...
    flash_mask: bool = field(
        default=False,
        metadata={"help": "Whether to use flash_mask in flash attention."},
    )
    _attn_implementation: str = field(
        default="flashmask", metadata={"help": "Attention implementation"}
    )
    flashmask_use_varlen: str = field(
        default=False,
        metadata={"help": "If True, convert flashmask to varlen in attention."},
    )

    # long sequence strategy
    use_long_sequence_strategies: bool = field(
        default=False,
        metadata={"help": "Whether to use long sequence strategy"},
    )
    rope_scaling_factor: float = field(
        default=1.0, metadata={"help": "Rope extension scaling factor"}
    )
    strategy_type: str = field(
        default=None, metadata={"help": "Long sequence strategy type"}
    )
    strategy_name: str = field(
        default=None, metadata={"help": "Long sequence strategy name"}
    )
    ...
    qlora_weight_blocksize: int = field(
        default=64,
        metadata={
            "help": "Block size for weight quantization(Only available for nf4 or fp4 weight_scale.)."
        },
    )
    qlora_weight_double_quant: bool = field(
        default=False,
        metadata={
            "help": "Whether apply double quant(Only available for nf4 or fp4 weight_scale.)."
        },
    )
    ...
    apply_hadamard: bool = field(
        default=False, metadata={"help": "Whether to apply hadamard"}
    )
    ...
    fp8_format_type: str = field(
        default="hybrid", metadata={"help": "FP8 Format"}
    )
    ...
    pp_seg_method: str | None = field(
        default="layer:DecoderLayer|EmptyLayer",
        metadata={"help": "PP Segmentation Method"},
    )
