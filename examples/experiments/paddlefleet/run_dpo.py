...
def main():
    ...
    if True:
        ...
        print("KKK: ", model.config.dpo_config)
        ref_model.set_state_dict(model.state_dict())
        ref_model.config.dpo_config = copy.deepcopy(dpo_config)
        ref_model.config.tensor_parallel_degree = training_args.tensor_parallel_degree
    else:
