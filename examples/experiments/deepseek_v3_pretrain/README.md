...
GPU: NVIDIA A100 80GB (推荐) 或 H800、H20等
...
|reorder_pipeline_priority|training_args.py:  在 order 顺序里把 sharding 和 pp 的优先级提前|无|python 启动命令<br>例：python -u run_pretrain.py ./config/pretrain_argument.json --reorder_pipeline_priority=True|
