...
install_requirements() {
    ...
    python -m pip install -r requirements.txt python -m pip uninstall paddlepaddle paddlepaddle_gpu -y
    python -m pip install -r requirements-dev.txt python -m pip uninstall paddlepaddle paddlepaddle_gpu -y
    python -m pip install -r tests/requirements.txt python -m pip uninstall paddlepaddle paddlepaddle_gpu -y
