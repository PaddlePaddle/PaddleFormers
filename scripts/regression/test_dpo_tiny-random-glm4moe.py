...
DPO_FULL_EXCEPTED_RESULT = [[10564, 10564, 10564, 138932, 102954, 47231, 47231, 47231, 47231, 47231]]

DPO_LORA_EXCEPTED_LOSS = 0.693147
DPO_LORA_RESUME_EXCEPTED_LOSS = 0.692273
DPO_LORA_EXCEPTED_RESULT = [[10564, 10564, 102954, 47231, 47231, 47231, 47231, 47231, 47231, 47231]]

DPO_FULL_TP_PP_EXCEPTED_LOSS = 0.693147
DPO_FULL_TP_PP_RESUME_EXCEPTED_LOSS = 0.69417
DPO_FULL_TP_PP_EXCEPTED_RESULT = [[10564, 10564, 10564, 138932, 102954, 47231, 47231, 47231, 47231, 47231]]

DPO_LORA_TP_PP_EXCEPTED_LOSS = 0.693147
DPO_LORA_TP_PP_RESUME_EXCEPTED_LOSS = 0.693195
